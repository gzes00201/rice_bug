...
export const taskConfig = [
  ...
  [
    ...
    new RiceBugTaskImp('1-3', '製作系統的login功能、請找LE協助建置資料庫環境', Worker.RD, 4),
    ...
    new RiceBugTaskImp('1-7', '架設米ber伺服器V1,此伺服器需要 Server v.1,Proxy v.1', Worker.TO, 5),
  ],
  {
    config: 1,
    server: 1,
  ...
  { current: 3, last: 3 },
  { current: 5000, last: 5000 }, [
    new RiceBugTaskImp('4-1', '使系統支援RWD、規劃RWD支援螢幕尺寸', Worker.RO, 3),
    ...
    new RiceBugTaskImp('4-5', '使用 NODE 14 版環境、規劃Node14運作環境,並通知TO升級Server v.2', Worker.LE, 2),
  ...
  { current: -1000, last: -1000 }, [
    ...
    new RiceBugTaskImp('5-2', '重啟並還原商品資料庫', Worker.ITSUPORT, 4),
  ]),
  new RiceBugProjectImp(2, '6.蝦米購物 貨到付款', false,
  { current: -1, last:  -1 },
  { current: -2000, last: -2000 }, [
    new RiceBugTaskImp('6-1', '貨到付款系統故障,通知服務器重啟', Worker.LE, 2),
    new RiceBugTaskImp('6-2', '重啟貨到付款資料庫', Worker.ITSUPORT, 4),
    new RiceBugTaskImp('6-3', '重啟貨到付款服務器,並通知貨到付款資料庫重啟', Worker.TO, 4),
  ]),
  ...
  { current: -2000, last: -2000 }, [
    ...
    new RiceBugTaskImp('7-3', '重啟訂單主機', Worker.TO, 2),
  ]),
  ...
  { current: 3, last: 3 },
  { current: 10000, last: 10000 }, [
    new RiceBugTaskImp('10-1', '確認GPS的需求、與美術確認設計畫面及風格', Worker.RO, 3),
  ...
  { current: 20000, last: 20000 }, [
    new RiceBugTaskImp('11-1', '參與使用者訪談、依照訪談結果規劃APP核心功能', Worker.RO, 3),
  ...
  { current: 3, last: 3 },
  { current: 10000, last: 10000 }, [
    new RiceBugTaskImp('12-1', '確認直播功能的主要方向、確認畫面視覺設計', Worker.RO, 3),
    ...
    new RiceBugTaskImp('12-7', '協助 TO 直播 server 需更新', Worker.CM, 1),
    new RiceBugTaskImp('12-8', '協助 LE 使用 NODE 16 版環境', Worker.CM, 1),
    new RiceBugTaskImp('12-9', '使用 NODE 14 版環境、規劃Node14運作環境,建置直播服務與線路,通知ＴＯ架設伺服器與通知IT Support', Worker.LE, 3),
    new RiceBugTaskImp('12-10', '建置直播資料庫、升級資料庫Config v.3', Worker.ITSUPORT, 5),
    new RiceBugTaskImp('12-11', '架設直播主機、升級Server v.3', Worker.TO, 5),
  ],{
    config: 3,
    server: 3,
    proxy: 1
  ...
  { current: -1500, last: -1500 }, [
    new RiceBugTaskImp('13-1', '擬定備案並通知技術協助處理', Worker.RO, 2),
    ...
    new RiceBugTaskImp('13-6', '查詢發票系統log 發現發票資料庫欄位有不見,通知IT SUPPORT還原資料庫', Worker.TO, 4),
  ]),
  new RiceBugProjectImp(3, '14.蝦米購物 稅務系統位數不足', false,
  { current: 0, last:  0 },
  { current: -15000, last: -15000 }, [
    new RiceBugTaskImp('14-1', '與CFO確認並通知技術協助處理', Worker.RO, 1),
  ...
  { current: 20000, last: 20000 }, [
    ...
    new RiceBugTaskImp('16-8', '建立評價系統資料庫、升級 Config v.4', Worker.ITSUPORT, 4),
    new RiceBugTaskImp('16-9', '評價即時更新主機建置、升級Server v.4', Worker.TO, 4),
  ],{
    config: 4,
    server: 4,
    proxy: 2
  ...
  { current: 10000, last: 10000 }, [
    ...
    new RiceBugTaskImp('29-5', 'MIJI 銷售系統自動修改即期商品價格', Worker.CM, 3),
  ...
  { current: 15000, last: 15000 }, [
    ...
    new RiceBugTaskImp('40-7', '建立退貨代收服務主機', Worker.TO, 4),
  ]),
  ...
  { current: 10000, last: 10000 }, [
    ...
    new RiceBugTaskImp('43-7', '擴充伺服器主機 升級 Server v.5', Worker.TO, 4),
  ],{
    config: 5,
    server: 5,
    proxy: 1
  ...
  { current: 5000, last: 5000 }, [
    ...
    new RiceBugTaskImp('45-3', '更新貨運系統特殊節日運費計算邏輯', Worker.CM, 2),
  ...
  { current: 5000, last: 5000 }, [
    ...
    new RiceBugTaskImp('46-3', '用戶系統新增米 ber 邀請碼邏輯', Worker.CM, 2),
  ...
  { current: 5000, last: 5000 }, [
    ...
    new RiceBugTaskImp('47-4', '更新米倉公司形象網站', Worker.CM, 3),
